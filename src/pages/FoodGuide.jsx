...
export default function FoodGuide() {
  ...
  return <main className="food-page">
    ...
    <label className="food-search"><Search size={15}/><input value={query} onChange={event => setQuery(event.target.value)} placeholder="Search food, place, or community"/>{query && <button type="button" onClick={() => setQuery('')} aria-label="Clear food search"><X size={15}/></button>}</label>
