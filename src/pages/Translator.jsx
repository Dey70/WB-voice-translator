        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              background:
                mode === m.id ? "rgba(108,99,255,0.15)" : "var(--bg-card)",
              color:
                mode === m.id
      ...
      >
        <div style={{ flex: 1, minWidth: 180 }}>
          ...
          <LanguageSelector
            ...
            onChange={(v) => {
              setFromLang(v);
              if (v === toLang) setToLang(fromLang);
            }}
          />
        </div>
        <button
        ...
        <div style={{ flex: 1, minWidth: 180 }}>
          ...
          <LanguageSelector
            ...
            onChange={(v) => {
              setToLang(v);
              if (v === fromLang) setFromLang(toLang);
            }}
            exclude={fromLang}
          />
        </div>
      ...
      >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div
                style={{
                  ...
                  fontSize: 10,
                  fontWeight: 700,
                  color: fromLangData.color,
                }}
              >
                {fromLangData.label || fromLang.toUpperCase()}
              </div>
              <span
                style={{
                  fontWeight: 600,
              ...
              >
                {fromLangData.nativeName}
              </span>
            </div>
            {isListening && (
              <Waveform active={true} color={fromLangData.color} />
            )}
          </div>

          <textarea
            value={
              isListening && interimText && !inputText ? interimText : inputText
            }
        ...
        <div className="glass" style={{ borderRadius: 14, padding: 18 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div
                style={{
                  ...
                  fontSize: 10,
                  fontWeight: 700,
                  color: toLangData.color,
                }}
              >
                {toLangData.label || toLang.toUpperCase()}
              </div>
              <span
                style={{
                  fontWeight: 600,
          ...
          >
            ...
            <button
              onClick={() => (isSpeaking ? stop() : speak(outputText, toLang))}
              disabled={!outputText}
              style={{
                display: "flex",
                alignItems: "center",
                ...
                border:
                  "1px solid " +
                  (isSpeaking ? "var(--accent-primary)" : "var(--border)"),
                color: isSpeaking
                  ? "var(--accent-secondary)"
                  : "var(--text-secondary)",
                cursor: outputText ? "pointer" : "not-allowed",
      ...
      {(mode === "voice-voice" || mode === "voice-text") && (
        ...
        >
          {!isSupported ? (
            ...
            >
              Voice input is not supported by your current browser. Please try
              using Chrome.
            </div>
          ) : (
            <>
