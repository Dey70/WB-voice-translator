...
const COPY = {
  en:{ eyebrow:'Plan your regional journey', title:'Places', subtitle:'Choose how you want to plan: discover destinations now or compare the best seasons first.', explore:'Explore Nearby', exploreText:'Browse 124 curated attractions, surrounding road trips, hidden gems, access filters, and Google Maps directions.', season:'Seasonal Guide', seasonText:'Compare normal weather, road, forest, sea, festival, and high-altitude conditions across all eight regions.', open:'Open guide' },
